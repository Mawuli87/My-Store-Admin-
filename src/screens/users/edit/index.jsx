...
const EditUser = async ({ params }) => {
  ...
  console.log("User data AND " + userData);

  // Server action function. send form data
  async function updateUserData(formData) {
    "use server";
    await updateUser(formData, userData.id); // Await if updateUser is asynchronous
    console.log("Form data:", formData.get("userName"));

    // Additional server-side logic can go here
  }
